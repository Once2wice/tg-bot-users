...
# Команды бота
/start - запуск бота
/group - выводит inline-кнопки на которых указаны названия групп, привязанные к чату модераторов. Нажав на кнопку с соответствующей группой, выводятся последние 3 претендента для поздравления. 
